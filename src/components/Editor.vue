...
const handleChange = (value: string) => {
  console.log('code changed', code.value)
  ...
  <div class="dark:bg-zinc-800 p-5">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-x-4">
        <span v-if="copied" class="text-green-600">Copied successfully!</span>
        ...
        <button 
          class="border p-1 rounded-md border-gray-500 text-gray-400 hover:text-gray-200" >
    ...
    <p class="border-t my-2"></p>
    <MonacoEditor class="min-h-32" language="python" v-model:value="code" :options="editorOptions"
